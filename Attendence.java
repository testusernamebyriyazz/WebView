...
public class Attendence extends AppCompatActivity {
    ...
    String address = "http://saikapyar.in/learningPAthSchool/teacherName.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(getApplicationContext(),Email,Toast.LENGTH_LONG).show();
        ...
        adapter = new AdapterTeacher(getBaseContext(), R.layout.class_single, actorsList);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            // Toast.makeText(getApplicationContext(),actorsList.get(position).getDob(),Toast.LENGTH_LONG).show();
             //   SectionsLIst sec = new SectionsLIst(actorsList.get(position).getDob());
                Intent intent = new Intent(Attendence.this,SectionsLIst.class);
                intent.putExtra("classid",actorsList.get(position).getDob());
    ...
    private  int parse(String data)
    {
        try
        {
            ...
            for(int i=0; i<jsonArray.length();i++)
            {
                ...
                stu.setName(jsonObject.getString("ClassName"));
