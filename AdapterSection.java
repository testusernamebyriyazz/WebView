...
/**
 * Created by Perfect on 9/24/2017.
 */

public class AdapterSection extends ArrayAdapter<Actors> {
    ArrayList<Actors> actorList;
    LayoutInflater vi;
    int Resource;
    AdapterTeacher.ViewHolder holder;

    public AdapterSection(Context context, int resource, ArrayList<Actors> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            holder.tvName = (TextView) v.findViewById(R.id.secname);
